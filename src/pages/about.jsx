            ...
            <Row className="mt-5">
              <Col lg="6" xs="12" className="pres-about">
                ...
                <p>
                  ...
                  . J’ai ensuite fait une licence professionnelle en
                  Communication digitale à{" "}
                  <a
                    href={links.tarbes}
                ...
                <p>
                  ...
                  moment) en Javascript, notamment avec React mais aussi Node
                  JS, j’ai décroché un stage chez{" "}
                  <a
                    href={links.commit42}
                    className="yellow-underline"
                    target="_blank"
                ...
                <p>
                  Le web n’est pas la seule chose qui me fait vibrer, j’aime
                  tout particulièrement l'illustration, la{" "}
                  <a
